...
export default function DeJoinPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!phoneNumber.trim() && !email.trim()) {
      setError('Bitte gib mindestens eine Telefonnummer oder E-Mail-Adresse an.');
      return;
    }
    if (!turnstileToken) {
      setError('Bitte schließe die Verifizierung ab.');
      return;
    }
    ...
    <div className={styles.pageNarrow}>
      <div className={styles.loginCard}>
        <div className={styles.loginHeader}>
          ...
          <h1 className={styles.loginTitle}>Mitgliedschaft beantragen</h1>
          <p className={styles.loginSubtitle}>
            Füll das Formular aus und wir melden uns bald bei dir.
          </p>
        </div>

        <p style={{ marginTop: 0, marginBottom: '1.5rem' }}>
          <a href="/de/care/login" style={{ color: 'var(--hunter-green)', fontSize: '0.875rem', textDecoration: 'none' }}>
            ← Zurück zum Login
          </a>
        </p>
        ...
        {submitted ? (
          <div style={{
            ...
            Deine Anfrage wurde eingereicht! Wir melden uns bald bei dir.
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            ...
            <div className={styles.formGroup}>
              <label className={styles.label} htmlFor="phone">Handynummer</label>
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', flexShrink: 0 }}>
                  ...
                  <span
                    title="Purrfect Love Care ist derzeit nur in Indien und Deutschland verfügbar"
            ...
            <div className={styles.formGroup}>
              ...
              <textarea
                id="message"
                className={styles.input}
                placeholder="Erzähl uns etwas über dich und warum du Mitglied werden möchtest…"
                value={message}
            ...
            <div style={{ marginBottom: '1rem' }}>
              <Turnstile
                ...
                onError={() => setError('Verifizierung fehlgeschlagen. Bitte lade die Seite neu und versuche es erneut.')}
